...
class Personagem{
    ...
    public boolean pesquisar(String nome, Personagem personagem){
        boolean resp = false;

        for (int i = 0; i < nome.length(); i++){
            if (nome.charAt(i) == personagem.nome.charAt(i)){
                resp = true;
            }
            else{
                resp = false;
...
class Pesquisa{
    ...
    public void pesquisa(String nome){
        ...
        for(int i = 0 ; i < n; i++){
            personagem = this.array[i];
            if(this.array[i].pesquisar(nome, personagem)){
                contem = true;
                i = n;
            }
            else{
    ...
    public static void main (String[] args) throws Exception{
        ...
        String nome = "";
        int aux = 0;
        Pesquisa lista = new Pesquisa(1000);
