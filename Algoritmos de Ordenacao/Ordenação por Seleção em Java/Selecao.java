...
class Selecao{
    ...
    public void construirArrayNome(Selecao lista){
    ...
    public void ordenarSelecao(Selecao lista){
        for(int i = 0; i < (lista.n - 1); i++){
            String nome1 = lista.arrayNome[i];
            int menor = i;
            for(int j = (i+1); j < lista.n; j++){
                String nome2 = lista.arrayNome[j];
                if (nome2.compareTo(nome1) < 0){
                    menor = j;
                }
            }
            lista.swap (menor, i, lista);
        }
    }

    public void swap(int a, int b, Selecao lista){
        Personagem tmp;
        String nomeTmp;
    ...
    public static void main (String[] args) throws Exception{
        String nomeArquivo = "";
        int aux = 0;
        Selecao lista = new Selecao(1000);
        ...
        lista.arrayNome = new String[lista.n];
        lista.construirArrayNome(lista);
        lista.ordenarSelecao(lista);
        lista.mostrar();
    }
}