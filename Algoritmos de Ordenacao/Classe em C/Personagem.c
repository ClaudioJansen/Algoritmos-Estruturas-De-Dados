...
struct Personagem tratarPersonagem (char* linha, char* nome, char* corDoCabelo, char* codDaPele, char* corDosOlhos,
    ...
    nome = string_substring(linha, a, b);
    ...
    altura = atoi(string_substring(linha, a, b));
    ...
    str = string_substring(linha, a, b);
    ...
    corDoCabelo = string_substring(linha, a, b);
    ...
    codDaPele = string_substring(linha, a, b);
    ...
    corDosOlhos = string_substring(linha, a, b);
    ...
    anoNascimento = string_substring(linha, a, b);
    ...
    genero = string_substring(linha, a, b);
    ...
    homeworld = string_substring(linha, a, b);
...
char* string_substring(char str[], int start, int end){//metodo substring
    int i, j;
    char *sub; 
